...
namespace BionetTX.Controllers
{
    public class HomeController : Controller
    {
        ...
        #region 中文版-Meta Exosome 居家保養系列 Meta Exosome (B2C)
        ...
        #region 中文版-ANIKINE 臨床研究數據 Clinical research data
